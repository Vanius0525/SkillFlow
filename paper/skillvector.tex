...
patched positions are the document's own. The clinical material shows the same
shape independently: writing donor states at the last $1$, $16$ and up to $256$
positions \emph{after} the skill recovers $0.03$, $0.06$ and $0.05$
(\S\ref{sec:decomp}), also flat in the number of positions. On both materials,
positions the document does not occupy do not buy recovery in proportion to how
many of them are written. We therefore read the low ceiling as
